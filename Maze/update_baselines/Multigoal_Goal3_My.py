...
if __name__ == "__main__":
    ...
    for t in range(max_timsteps):
        ...
        if (t+1) % 3000 == 1:
            ...
            save_path = f'/home/yuxuanli/failed_IRL_new/Maze/update_baselines/models/MyMethod_models/mid_189_3/mid_reward_{t+1}.pth'
            torch.save(reward_net.state_dict(), save_path)

            fig_save_path = f"/home/yuxuanli/failed_IRL_new/Maze/update_baselines/models/MyMethod_models/mid_189_3/my_map2_rewardnet_{t+1}.png"
