...
def parse_args():
    ...
    parser.add_argument('--reward_epochs', type=int, default=100)
...
if __name__ == "__main__":
    ...
    batch_size = 512
    # episodes = int(5e6)
    max_timsteps = int(500e3) #int(6e4)
    ...
    torch.save(reward_net.state_dict(), "/home/xlx9645/failed/Maze/update_baselines/models/MaxEnt/mid_16/maxent_rewardnet.pth")