...
def construct_obs(achieved_goal, desired_goal):
...
def visualize_bcirl_reward_function(reward_net_path, state_dim, action_dim, device, figure_save_path):
    ...
    desired_goals = [(0, 0), (2.5, 0), (-2.5, 2)]
    plt.figure(figsize=(18, 6))

    for index, desired_goal in enumerate(desired_goals, 1):
        obs_list = [construct_obs(ag, desired_goal) for ag in achieved_goals]
        ...
        plt.title(f"BC-IRL Reward Function Visualization\nDesired Goal {desired_goal}")
...
if __name__ == "__main__":
    ...
    for t in range(max_timsteps):
        ...
        if (t+1) % 3000 == 1:
            ...
            save_path = f'/home/yuxuanli/failed_IRL_new/Maze/update_baselines/models/MyMethod_models/mid_1689_2/mid_reward_{t+1}.pth'
            torch.save(reward_net.state_dict(), save_path)

            fig_save_path = f"/home/yuxuanli/failed_IRL_new/Maze/update_baselines/models/MyMethod_models/mid_1689_2/my_map2_rewardnet_{t+1}.png"
