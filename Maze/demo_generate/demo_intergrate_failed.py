...
# 文件路径格式
base_path = '/Users/yuxuanli/Maze/demos/acc_ranReset_failed/'
file_prefix = 'failed_demo_'
file_extension = '.pkl'

# 合并文件
for i in range(1, 21):  # 从 1 到 51
...
combined_demo_path = '/Users/yuxuanli/Maze/demos/acc_ranReset_failed/all_failed_demos.pkl'
