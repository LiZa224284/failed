...
# Extract data
success_obs, success_rewards = extract_last_achieved_goals_with_rewards(success_demos, reward_value=1, exp_k=2, last_n=5)
failed_obs, failed_rewards = extract_last_achieved_goals_with_rewards(failed_demos, reward_value=-1, exp_k=1, last_n=5)
