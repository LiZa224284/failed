...
# Extract data
# success_obs, success_rewards = extract_last_achieved_goals_with_rewards(success_demos, reward_value=1, exp_k=2, last_n=10)
# failed_obs, failed_rewards = extract_last_achieved_goals_with_rewards(failed_demos, reward_value=-1, exp_k=3, last_n=500)
...
success_obs, success_rewards = extract_obs_and_labels(success_demos, 1)
failed_obs, failed_rewards = extract_obs_and_labels(failed_demos, 0)

# Combine success and failed data for training
total_obs = np.concatenate((success_obs, failed_obs))
total_rewards = np.concatenate((success_rewards, failed_rewards))
# total_obs = failed_obs
# total_rewards = failed_rewards
...
data_loader = DataLoader(dataset, batch_size=64, shuffle=True) #256
