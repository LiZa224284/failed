...
# 文件路径格式
base_path = '/Users/yuxuanli/Maze/demos/success/'
file_prefix = 'success_demo_'
file_extension = '.pkl'

# 合并文件
for i in range(1, 74):  # 从 1 到 73
...
# 保存合并后的数据
output_file = os.path.join(base_path, 'all_success_demos.pkl')
...
combined_demo_path = '/Users/yuxuanli/Maze/demos/success/all_success_demos.pkl'
