...
if __name__ == "__main__":
    ...
    algorithm_name = f"100000_KR_SFO_exp{args.exp_k}_bw{args.kernel_bandwidth}"
    env_name = 'FL'
    exp_k = args.exp_k
    ...
    kr_model.load_state_dict(torch.load("/home/yuxuanli/failed_IRL_new/Deep_Model/KR_Deep_Model_SFD_100000.pth"))
