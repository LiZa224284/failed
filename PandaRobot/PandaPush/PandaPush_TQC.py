...
if __name__ == "__main__":
    ...
    algorithm_name = 'PandaPush_TQC'
    env_name = 'PandaPush-v3'
    total_timesteps = int(8e7)#10000
    n_iterations = 200
    ...
    # model = TD3('MultiInputPolicy', env, action_noise=action_noise, verbose=0, device="cuda")
    ...
    model.save("/files1/Yuxuan_Li/failed_demos/Experiments/Robots/PandaPush/PandaPush_TQC_3_model.zip") #andaReacher_TD3_model.zip
