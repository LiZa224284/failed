...
callback = WandbCallback(log_dir='/home/xlx9645/failed/PandaRobot/PandaPickAndPlace/log', check_interval=10)
model.learn(total_timesteps=int(600e3), callback=callback)
model.save("/home/xlx9645/failed/PandaRobot/PandaPush/model/MyPush2_TQC_model.zip")