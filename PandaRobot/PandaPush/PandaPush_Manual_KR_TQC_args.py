...
def parse_args():
    ...
    parser.add_argument('--n_s_demos', type=int, default=1, help='Number of training iterations.')
    parser.add_argument('--n_f_demos', type=int, default=1, help='Number of training iterations.')
    return parser.parse_args()

if __name__ == "__main__":
    args = parse_args()
    project = "PandaPush_test"
    algorithm_name = f"TQC_Manual_KR_exp{args.exp_k}_bw{args.kernel_bandwidth}_sdmeo{args.n_s_demos}__fdmeo{args.n_f_demos}"
