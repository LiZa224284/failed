...
def parse_args():
    ...
    parser.add_argument('--n_s_demos', type=int, default=200, help='Number of training iterations.')
...
if __name__ == "__main__":
    ...
    algorithm_name = f"SAC_KR_exp{args.exp_k}_bw{args.kernel_bandwidth}_sdmeo{args.n_s_demos}__fdmeo{args.n_f_demos}"
