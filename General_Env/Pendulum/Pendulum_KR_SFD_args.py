...
def parse_args():
    ...
    parser.add_argument('--n_s_demos', type=int, default=5, help='Number of training iterations.')
    parser.add_argument('--n_f_demos', type=int, default=5, help='Number of training iterations.')
    return parser.parse_args()

if __name__ == "__main__":
    args = parse_args()
    project = "InvertedPendulum_1030"
    # algorithm_name = 'KR_SFD_exp1_bw01'
    algorithm_name = f"TD3_KR_exp{args.exp_k}_bw{args.kernel_bandwidth}_sdmeo{args.n_s_demos}__fdmeo{args.n_f_demos}"
