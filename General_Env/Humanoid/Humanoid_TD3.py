...
if __name__ == "__main__":
    ...
    algorithm_name = 'Humanoid_Td3'
    env_name = 'Humanoid-v4'
    total_timesteps = int(15e5)#10000
    n_iterations = 200
    ...
    model.save("/files1/Yuxuan_Li/failed_demos/Experiments/General_Env/Humanoid/Humanoid_TD3_model.zip")
