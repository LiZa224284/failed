...
# model = rollout_model.load("/files1/Yuxuan_Li/failed_demos/Experiments/General_Env/Humanoid/Humanoid_TD3_model.zip", env) 
...
env.close()
imageio.mimsave('/files1/Yuxuan_Li/failed_demos/Experiments/General_Env/Humanoid/Humanoid.mp4', frames, fps=30)
