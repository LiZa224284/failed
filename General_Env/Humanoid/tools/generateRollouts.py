...
with open('/files1/Yuxuan_Li/failed_demos/Experiments/General_Env/Humanoid/rollouts.pkl', 'wb') as f:
    pickle.dump(rollouts, f)
with open('/files1/Yuxuan_Li/failed_demos/Experiments/General_Env/Humanoid/failed_rollouts.pkl', 'wb') as f:
